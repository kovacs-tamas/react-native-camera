...
public class CameraModule extends ReactContextBaseJavaModule {
  ...
  public void getSupportedRatios(final int viewTag, final Promise promise) {
    ...
    @ReactMethod
    public void checkCamerasAvailability(final Promise promise) {
        ...
        result.putBoolean("hasBackCamera", hasBackCamera);
        result.putBoolean("hasFrontCamera", hasFrontCamera);
        promise.resolve(result);
    }
}
