...
interface CaptureVideoFrameResponse {
    data: string;
}

interface CheckCamerasAvailabilityResponse {
...
export class RNCamera extends Component<RNCameraProps & ViewProperties> {
    ...
    captureVideoFrame(isMirrored: boolean): Promise<CaptureVideoFrameResponse>;
    checkCamerasAvailability(): Promise<CheckCamerasAvailabilityResponse>;
    pausePreview(): void;
    resumePreview(): void;
